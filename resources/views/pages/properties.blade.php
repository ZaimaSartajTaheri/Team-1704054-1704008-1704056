    ...
    <!------ Featured ------>
                ...
                <div class="col-md-10">
                    <div class="tabbed_container">
                        <div class="tabs">
                            <ul class="clearfix">
                                <li class="active">@if(session()->get('lang') == 'bangla')হাসপাতাল @else Hospitals @endif</li>
                                <li>@if(session()->get('lang') == 'bangla')স্কুল @else Schools @endif</li>
                                <li>@if(session()->get('lang') == 'bangla')মার্কেট @else Markets @endif</li>
                                <li>@if(session()->get('lang') == 'bangla')পার্ক @else Parks @endif</li>
                            </ul>
                        ...
                        <div class="product_panel panel active">
                            {{-- <div class="featured_slider slider pb-5 mb-5"> --}}
                                  ...
                                  <!---------------------------------------------------------------->
                                    ...
                                    <div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center" style="margin-left:4.5%;">
                                        ...
                                        <table class="table">
                                            ...
                                            <thead>
                                              <tr>
                                                ...
                                                <th style="width:40%" >Hospitals</th>
...
<!------------------------Start Right_Side_Bar------------------------->
    <div class="mt-3" style="border-left:1px solid blue;">
        <!-- Shop Content -->
