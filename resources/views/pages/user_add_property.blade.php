    ...
    <div class="form-row">
        ...
        <div class="col-md-4 mb-3 pr-4">
            ...
            <select class="custom-select form-control ml-0 text-muted d-block" name="subcity_id" id="v5" required>
                <option value="">Choose your subcity</option>
    ...
    <div class="form-row">
        <div class="col-lg-12">
            ...
            <label for="details" class="form-control-label">Property Details :</label>
                <textarea class="form-control text-muted" id="details"  placeholder="Your Property Description Will Go Here..." name="details" rows="5" required>
                </textarea>
            </div>
        </div>
    </div>
