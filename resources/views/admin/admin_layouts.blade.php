  ...
  <body>
    ...
    <div class="sl-sideleft">
      <div class="sl-sideleft-menu">
        ...
        <a href="{{ route('add.info') }}" class="sl-menu-link">
          <div class="sl-menu-item">
            <i class="menu-item-icon icon ion-ios-filing-outline tx-24"></i>
            <span class="menu-item-label">Add Information</span>
            <i class="menu-item-arrow fa fa-angle-down"></i>
          </div><!-- menu-item -->
        </a>
...
{{-------- data Tables JS -------}}
    ...
    {{-- <script src="{{ asset('public/backend/lib/rickshaw/rickshaw.js')}}"></script>
